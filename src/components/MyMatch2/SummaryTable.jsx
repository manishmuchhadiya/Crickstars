...
const SummaryTable = ({ phoenixElevenLogo }) => {
  return (
    <>
      ...
      <div className=" w-[568px] h-[519px] ">
        {/* team */}
        <div className=" w-full h-[144px]  rounded-[20px] flex justify-between px-[20px] pt-[20px] pb-[30px] shadow-[0_4px_25px_0_rgba(0,0,0,0.03)]">
          <div className="">
        ...
        {/* table */}
        <div className="border-red-600 rounded-[20px] border-0 w-[568px] h-[355px] mt-[20px]">
